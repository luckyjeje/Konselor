...
import aplikasi.kelompok.konselor.databinding.ActivityMainBinding;
import aplikasi.kelompok.konselor.menu.ChatFragment;
import aplikasi.kelompok.konselor.menu.InfoFragment;
import aplikasi.kelompok.konselor.menu.KontakFragment;
...
public class MainActivity extends AppCompatActivity {
    ...
    private void aturViewPager(ViewPager viewPager){
        ...
        adapter.tambahFragment(new InfoFragment(), "Info");
