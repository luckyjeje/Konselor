...
import aplikasi.kelompok.konselor.adapter.AdapterPesan;
import aplikasi.kelompok.konselor.databinding.ActivityChattingBinding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.btnKirim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (!TextUtils.isEmpty(binding.tulisPesan.getText().toString())){
                    kirimPesan(binding.tulisPesan.getText().toString());
                    binding.tulisPesan.setText("");
                }
            }
        });
